...
if niput == 1:
  ...
  mostRecentPlayerInput = playerInput[-13:]
  ...
  while running:
      ...
      if key == "w":
          if Player.y != 0:
              ...
              Player.y = 29
              Player.bigY -= 1
              if Player.bigY >= worldGenSideLength:
                  Player.bigY = 0
              else:
                  if worldMap[Player.bigY, Player.bigX, Player.y, Player.x] != Fore.BLACK + '██' and worldMap[Player.bigY, Player.bigX, Player.y, Player.x] != Fore.LIGHTBLACK_EX + '██':
                      map = make_map(mapSideLength, Player)
                      worldMap[Player.bigY, Player.bigX] = map
                  else:
          ...
          if Player.x != 0:
              ...
              Player.x = 29
              Player.bigX -= 1
              if Player.bigX >= worldGenSideLength:
                  Player.bigX = 0
              else:
                  if worldMap[Player.bigY, Player.bigX, Player.y, Player.x] != Fore.BLACK + '██' and worldMap[Player.bigY, Player.bigX, Player.y, Player.x] != Fore.LIGHTBLACK_EX + '██':
                      worldMap[Player.bigY, Player.bigX] = make_map(mapSideLength, Player)
